...
void *thread1(void* arg)
{
	...
	for (;tmp_block < tmp_block_max; tmp_block++)
	{
		...
		if(tmp_block % 4 == 1)
		{
			sprintf(filename, "/mnt/sdb1/data_64m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 2)
		{
			sprintf(filename, "/mnt/sdc1/data_64m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 3)
		{
			sprintf(filename, "/mnt/sdd1/data_64m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 0)
		{
			sprintf(filename, "/mnt/sde1/data_64m/%ld", tmp_block);
		}
		...
		//printf("tmp_result3 = \n%s\n", tmp_result3);
		//printf("sizeof(tmp_result3) = %d\nstrlen(tmp_result3) = %d\n", sizeof(tmp_result3), strlen(tmp_result3));
		//std::cin.ignore();
