...
#define block_max 65536
#define thread_num 32
#define block_offset 2048
...
void *thread1(void* arg)
{
	...
	for(; tmp_block < tmp_block_max; tmp_block++)
	{
		...
		{
			sprintf(filename, "/mnt/sdb1/data_1m/%ld", tmp_current_id);
		}
		else if(tmp_current_id % 4 == 2)
		{
			sprintf(filename, "/mnt/sdc1/data_1m/%ld", tmp_current_id);
		}
		else if(tmp_current_id % 4 == 3)
		{
			sprintf(filename, "/mnt/sdd1/data_1m/%ld", tmp_current_id);
		}
		else if(tmp_current_id % 4 == 0)
		{
			sprintf(filename, "/mnt/sde1/data_1m/%ld", tmp_current_id);
		}
