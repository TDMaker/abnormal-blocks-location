...
int main()
{
	...
	file_block.file_len[0] = 0x03;
	file_block.file_len[1] = 0xFF;
	...
	*/
	...
	for ( j = 0; j < BLOCKMOUNT; j++ )
	{
		...
		{
			sprintf( tmp_file_name, "/mnt/sdb1/data_64m/%ld", file_block.block_id);
		}
		else if(file_block.block_id % 4 == 2)
		{
			sprintf( tmp_file_name, "/mnt/sdc1/data_64m/%ld", file_block.block_id);
		}
		else if(file_block.block_id % 4 == 3)
		{
			sprintf( tmp_file_name, "/mnt/sdd1/data_64m/%ld", file_block.block_id);
		}
		else if(file_block.block_id % 4 == 0)
		{
			sprintf( tmp_file_name, "/mnt/sde1/data_64m/%ld", file_block.block_id);
		}
