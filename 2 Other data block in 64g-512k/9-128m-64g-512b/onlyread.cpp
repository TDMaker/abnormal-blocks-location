...
void *thread1(void* arg)
{
	...
	for (;tmp_block < tmp_block_max; tmp_block++)
	{
		...
		if(tmp_block % 4 == 1)
		{
			sprintf(filename, "/mnt/sdb1/data_128m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 2)
		{
			sprintf(filename, "/mnt/sdc1/data_128m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 3)
		{
			sprintf(filename, "/mnt/sdd1/data_128m/%ld", tmp_block);
		}
		else if(tmp_block % 4 == 0)
		{
			sprintf(filename, "/mnt/sde1/data_128m/%ld", tmp_block);
		}
