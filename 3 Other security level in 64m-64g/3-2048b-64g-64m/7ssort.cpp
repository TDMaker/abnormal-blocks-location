...
int main(void)
{
	...
	char encrypt_b[(security_level - 10) * level_b];
	...
	{
		memset(tmp_buffer, 0, security_level);
		memset(tmp_buffer2, 0, security_level);
		memcpy(tmp_buffer, mapped_mem + (security_level - 10) * i, (security_level - 10));
